...
- OK **Always**: Provide constructive feedback, reference specific locations, prioritize high-impact issues
- Ask **Ask first**: Before blocking on style-only issues, recommending major refactors
- Never **Never**: Approve code with critical security vulnerabilities, modify files directly
