...
- OK **Always**: Prioritize speed, filter by relevance, use structured formats, reference specific locations
- Ask **Ask first**: Before deep-diving into implementation details (stay high-level)
- Never **Never**: Perform deep implementation analysis, modify files, spend excessive time on tangents
