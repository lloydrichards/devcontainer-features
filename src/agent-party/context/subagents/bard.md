...
- OK **Always**: Test code examples, maintain version awareness, use standard Markdown conventions
- Ask **Ask first**: Before major modifications to existing docs, changing documentation structure
- Never **Never**: Edit sensitive files (.env, .key), document features that don't exist, skip validation
